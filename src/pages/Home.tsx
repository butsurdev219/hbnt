...
function Home(): JSX.Element {
    ...
    const [featuredDrop, setFeaturedDrop] = useState<any>()
    const [upcomingDrops, setUpcomingDrops] = useState<Array<any>>()
    ...
    return (
        <div className="">
            ...
            <div className="w-full upcoming-drops">
                <h3 className="text-lg font-medium my-10">Upcoming Drops</h3>
                <div className="overflow-x-auto pb-2"> 
                    <div className="flex">
                        {(upcomingDrops && upcomingDrops.length > 0)&&
                        upcomingDrops.map((v: any, k: number) => {
                            if (k == 0)
